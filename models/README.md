...
The following files are licensed under Apache 2.0 in compliance with their original license.

- [brand_model.tflite](https://github.com/google-coral/test_data)
- [brand_labels.csv](https://www.gstatic.com/aihub/tfhub/labelmaps/popular_us_products_V1_labelmap.csv)
- [ssd_mobilenet_v2_coco_quant_postprocess.tflite](https://github.com/google-coral/test_data)
- [coco_labels.txt](https://github.com/google-coral/test_data)
- [mobilenet_v1_1.0_224_quant.tflite](https://github.com/google-coral/test_data)
- [imagenet_labels.txt](https://github.com/tensorflow/tfjs-models)
